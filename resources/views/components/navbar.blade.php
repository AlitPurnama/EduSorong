...
@auth
    @if(Auth::user()->email_verified_at === null)
        <div class="bg-yellow-500 text-white py-2 px-4">
            <div class="max-w-5xl mx-auto flex items-center justify-between text-[13px]">
                <div class="flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                    </svg>
                    <span>Email Anda belum terverifikasi. Silakan cek email Anda atau <a href="{{ route('settings.show') }}" class="underline font-semibold">verifikasi di sini</a>.</span>
                </div>
