        ...
        <main class="max-w-5xl mx-auto px-4 lg:px-4 pt-10 pb-20 space-y-16">
            ...
            <section class="grid md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] gap-12 items-center">
                <div class="space-y-6 md:space-y-7">
                    <div class="inline-flex items-center gap-2 rounded-full bg-white border border-[#E7E0B8] px-4 py-1 text-[12px] text-[#6B6F7A] shadow-sm">
                        <span class="w-2 h-2 rounded-full bg-[#9DAE81]"></span>
                        <span>Platform crowdfunding terpercaya</span>
                    </div>
                    <div class="space-y-2">
                        <h1 class="text-[36px] md:text-[42px] font-semibold leading-[1.15] tracking-tight text-[#23252F]">
                            Bantu<br />
                            Wujudkan<br />
                            Mimpi Mereka
                        </h1>
                ...
                <div class="relative flex justify-end">
                    <img
                        src="{{ asset('images/Classroom.png') }}"
            ...
            <section id="cara-kerja" class="rounded-[32px] bg-[#2E3242] px-6 md:px-12 py-10 text-[14px] text-white shadow-[0_18px_40px_rgba(0,0,0,0.25)]">
                <div class="text-center space-y-2 mb-8">
                    ...
                    <p class="text-[14px] text-[#D4D7E5] max-w-2xl mx-auto leading-relaxed">
                        Transparansi adalah kunci. Kami memastikan setiap rupiah donasi Anda sampai ke tangan yang tepat.
                    </p>
                </div>
            ...
            <section class="space-y-6 bg-white rounded-[32px] px-6 md:px-10 py-9 shadow-[0_18px_40px_rgba(0,0,0,0.12)]">
                <div class="flex items-center justify-between gap-4 text-[15px]">
                    <div class="space-y-1">
                        <p class="font-semibold text-[#23252F]">Siswa Butuh Bantuanmu</p>
                        <p class="text-[14px] text-[#6B6F7A] leading-relaxed">
                            Mari bantu mereka melanjutkan sekolah hari ini.
                        </p>
                    </div>
                    <button class="inline-flex items-center gap-1 text-[13px] text-[#23252F] underline underline-offset-4">
                        <a href="{{ url('/kampanye') }}">Lihat semua</a>
            ...
            <section id="tentang-kami" class="grid md:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] gap-10 items-center bg-[#FFF7E5] rounded-[32px] px-6 md:px-10 py-9 text-[14px]">
                ...
                <div class="space-y-4 text-sm">
                    <p class="text-[11px] tracking-[0.18em] uppercase text-[#8C8F99]">
                        Tentang Kami
                    </p>
                    <h2 class="text-2xl font-semibold text-[#23252F] leading-snug">
                        Membangun Sorong<br />
                        Melalui Pendidikan
                    </h2>
                    <p class="text-[14px] text-[#50545F] leading-relaxed text-justify">
                        EduSorong lahir dari kepedulian masyarakat lokal untuk memutuskan rantai kemiskinan.
                        Kami percaya bahwa pendidikan adalah hak segala bangsa, termasuk putra-putri di pelosok Sorong.
                    </p>
                    <p class="text-[14px] text-[#50545F] leading-relaxed text-justif">
                        Tim kami terdiri dari relawan, pengajar, dan teknolog yang berdedikasi untuk
                        menjembatani donatur baik hati dengan siswa berprestasi yang membutuhkan.
                    </p>
                </div>
            </section>
        </main>
